...
Thank you for your interest in `strongloop-products`, an open source project
administered by StrongLoop.

Contributing to `strongloop-products` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strongloop-products)
